...
class MovieIndex extends StatefulWidget {
  ...
  final List<String> movieCategory;
  final String movieImage;
  final String movieLength;
  final List<String> movieShowtime;


  MovieIndex(this.movieName, this.movieCategory, this.movieImage, this.movieLength, this.movieShowtime);
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("Thời lượng: " + widget.movieLength + " phút",
                        style: TextStyle(color: Colors.grey, fontSize: 14),
                        textAlign: TextAlign.left),
                    Text(widget.movieShowtime.toString(),
                        style: TextStyle(color: Colors.grey, fontSize: 14),
                        textAlign: TextAlign.left),
